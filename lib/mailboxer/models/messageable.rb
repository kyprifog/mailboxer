module Mailboxer
  module Models
    module Messageable
      ...
      #as originator
      def send_message(recipients, msg_body, subject, sanitize_text=true, attachment=nil, message_timestamp = Time.now, uses_email=true)
        ...
        message.deliver false, sanitize_text, uses_email
      end
